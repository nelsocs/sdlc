...
for BM in $BMFILE; do
cd ${REPODIR}/$BM && ${BASEDIR}/brakeman/bin/brakeman -A -o ${BASEDIR}/reports/$BM.html && mail -s "$BM report" brakemanalerts@cryptzero.net < ${BASEDIR}/reports/$BM.html && cd ${BASEDIR} 
